...
export class ReportsPage implements OnInit{
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    ...
    public toast:ToastController,public modalCtrl: ModalController,public alertCtrl:AlertController) {
    ...
    prepareDashboard(data) {
      ...
      if(((data['Drill Details']))){
        ...
        if(this.totalRecords.length>0 && this.totalRecords[0].facilityName){
          ...
          this.showAlert("","No transactions available for the current month. Please navigate to other period.");
        }
